...
This repo includes a `CLAUDE.md` file that tells Claude how this site works. Copy it into your new repo and Claude will follow it automatically — no need to explain the setup each time.

This isn't required, but it's recommended. You can also just start a session and describe what you want from scratch.
